...
fn macro_cancel_on_press() {
    let cfg = "\
(dofsrc a b c)
(doflayer base (macro-cancel-on-press z 100 y) (macro x 100 w) c)";
    test_on_press(cfg);
    let cfg = "\
(dofsrc a b c)
(doflayer base (macro-repeat-cancel-on-press z 100 y 100) (macro x 100 w) c)";
    test_on_press(cfg);
}
...
fn macro_release_cancel_and_cancel_on_press() {
    let cfg = "\
(dofsrc a b c)
(doflayer base (macro-release-cancel-and-cancel-on-press z 100 y 100) (macro x 100 w) c)";
    test_release_and_on_press(cfg);
    let cfg = "\
(dofsrc a b c)
(doflayer base (macro-repeat-release-cancel-and-cancel-on-press z 100 y 100) (macro x 100 w) c)";
    test_release_and_on_press(cfg);
}
...
fn macro_release_cancel() {
    let cfg = "\
(dofsrc a b c)
(doflayer base (macro-release-cancel z 100 y 100) (macro x 100 w) c)";
    test_release(cfg);
    let cfg = "\
(dofsrc a b c)
(doflayer base (macro-repeat-release-cancel z 100 y 100) (macro x 100 w) c)";
    test_release(cfg);
}
